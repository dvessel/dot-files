...
if type lsd &>/dev/null; then
  ...
  alias a='lsd -A'
  alias l.='lsd -d .*'
  alias ll='lsd -l --blocks permission,date,name'
  alias la='lsd -lA --blocks permission,date,name'
  alias lt='lsd --tree --versionsort'
  alias gl='lsd -A --blocks date,git,name --date relative --gitsort'
  alias ml='lsd --blocks permission,user,group,links,name'
  alias sl='lsd --blocks size,links,name --total-size --size default --sizesort'
  alias tl='lsd --blocks date,links,name --timesort'
else
